...
output.to_csv("data/ctu_brutal_poi.csv", index=False)

df[["lon", "lat"]].to_csv("data/poi_background.csv", index=False)

"""
Total Processing Time: 894.1546 seconds
Total Points Processed: 82651
Average Latency: 10.8184 ms/query
"""