...
df <- read.csv("alpha_sensitivity_report.csv")

df <- df %>%
  rename(
    alpha_val = alpha,
    communities = `Community.numbers`,
    zoi_points  = `ZOI.numbers`
  )

comm_ticks <- c(720, 740, 760, 780, 800)
zoi_ticks  <- c(37000, 38000, 39000, 40000, 41000)
