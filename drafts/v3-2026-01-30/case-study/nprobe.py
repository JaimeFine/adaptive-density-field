...
for nprobe in nprobes:
    ...
    for fid, coords in flights.items():
        ...
        track_adf = np.array([adf(p) for p in track_ecef])
    ...
    output.to_csv(f"data/ctu_adf_poi_{nprobe}.csv", index=False)

"""
4:
Total Processing Time: 10.3729 seconds
Total Points Processed: 82651
Average Latency: 0.1255 ms/query

8:
Total Processing Time: 12.2659 seconds
Total Points Processed: 82651
Average Latency: 0.1484 ms/query

64:
Total Processing Time: 24.1309 seconds
Total Points Processed: 82651
Average Latency: 0.2920 ms/query

256:
Total Processing Time: 79.1013 seconds
Total Points Processed: 82651
Average Latency: 0.9571 ms/query
"""